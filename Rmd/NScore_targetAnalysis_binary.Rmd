...
intra_med = data.frame(Cluster=names(medians),Med=unlist(medians),n=unlist(n_compounds))

# intra cluster similarity and were the BioMap clusters fit
ggplot(intra_med,aes(x=Med)) + 
...
intra_med[order(intra_med$Med,decreasing = T),][1:10,]
