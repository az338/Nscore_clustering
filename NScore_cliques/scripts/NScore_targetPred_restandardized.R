...
l_ply(method, function(p) {
    system(paste('python predict_binary_heat.py ', p,' ~/Dropbox/ucc_az/bioseek_Xitong_Ellen/NScore_cliques/RECORRCTED_SMILES.smi 2>> ~/Dropbox/ucc_az/bioseek_Xitong_Ellen/NScore_cliques/error_struct.txt',sep=''))
# read and save rank matrix
    ...
    save(NScore_pred, file = paste('~/Dropbox/ucc_az/bioseek_Xitong_Ellen/NScore_cliques/NSPred_binary_heat_',p,'_recorrected.Rdata',sep=''))
#remove output file
